...
@section('ruta', route('plaga.create'))
@section('styles')
    <!-- Theme JS files -->
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('plaga.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <fieldset class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <label class="col-form-label col-lg-12">Unidades calor por ciclo <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="unidades_calor_ciclo" class="form-control"
                                        placeholder="Unidades calor por ciclo">
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="umbral_min" class="form-control"
                                        placeholder="Umbral minimo">
                                </div>

                                <div class="col-6">
                                    <label class="col-form-label col-lg-12">Umbral máximo</label>
                                    <input type="text" name="umbral_max" class="form-control"
