...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('asignacion.usuarios.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <fieldset class="mb-3">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2">
                            <i class="icon-map5"></i> Usuario <span class="text-danger">*</span>
                        </label>
                        <div class="col-lg-10">
                            ...
                            <span class="form-text text-muted">
                                ...
                                Seleccione un usuario para cargar sus zonas
                            </span>
                        </div>
                    </div>
