...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('configuracion-mqtt.usuarios.store') }}" method="POST">
                @csrf
                ...
                <fieldset class="mb-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            ...
                            <span class="form-text text-muted">Mínimo 6 caracteres</span>
                        </div>
                    </div>
                            ...
                            <div class="form-check form-check-switch form-check-switch-left">
                                <label class="form-check-label d-flex align-items-center">
                                    <input type="checkbox" name="activo" class="form-check-input-switch" value="1"
                                        checked data-on-text="Activo" data-off-text="Inactivo">
                            ...
                            <select name="estaciones_permitidas[]" class="form-control select2" multiple>
                                @foreach ($estaciones as $estacion)
                                    <option value="{{ $estacion->id }}"
                                        {{ in_array($estacion->id, old('estaciones_permitidas', [])) ? 'selected' : '' }}>
                                        {{ $estacion->uuid }}
                                        @if ($estacion->celular)
                                            - {{ $estacion->celular }}
                                        @endif
                            ...
                            <div class="form-check form-check-switch form-check-switch-left mb-2">
                                <label class="form-check-label d-flex align-items-center">
                                    <input type="checkbox" name="todos_parametros" id="todos_parametros"
                                        class="form-check-input-switch" data-on-text="Sí" data-off-text="No">
                                ...
                                <div class="form-check mb-2">
                                    <label class="form-check-label">
                                        <input type="checkbox" name="parametros_permitidos[PCF]"
                                            ...
                                            {{ old('parametros_permitidos.PCF') ? 'checked' : '' }}>
                                ...
                                <div class="form-check mb-2">
                                    <label class="form-check-label">
                                        <input type="checkbox" name="parametros_permitidos[PCR]"
                                            class="form-check-input-styled" value="1"
                                            {{ old('parametros_permitidos.PCR') ? 'checked' : '' }}>
                                        PCR (Reset diario)
                                    </label>
                                </div>
                                <div class="form-check mb-2">
                                    <label class="form-check-label">
                                        <input type="checkbox" name="parametros_permitidos[PTP]"
                                            class="form-check-input-styled" value="1"
                                            {{ old('parametros_permitidos.PTP') ? 'checked' : '' }}>
                                ...
                                <div class="form-check mb-2">
                                    <label class="form-check-label">
                                        <input type="checkbox" name="parametros_permitidos[PTC]"
                                            class="form-check-input-styled" value="1"
                                            {{ old('parametros_permitidos.PTC') ? 'checked' : '' }}>
                                ...
                                <div class="form-check mb-2">
                                    <label class="form-check-label">
                                        <input type="checkbox" name="parametros_permitidos[PTR]"
                                            class="form-check-input-styled" value="1"
                                            {{ old('parametros_permitidos.PTR') ? 'checked' : '' }}>
                                        PTR (Tiempo de reset)
                                    </label>
                                </div>
                                <div class="form-check mb-2">
                                    <label class="form-check-label">
                                        <input type="checkbox" name="parametros_permitidos[PRS]"
                                            class="form-check-input-styled" value="1"
                                            {{ old('parametros_permitidos.PRS') ? 'checked' : '' }}>
                ...
                <div class="form-group row">
                    <div class="col-lg-10 offset-lg-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="icon-checkmark2 mr-2"></i> Crear Usuario
                        </button>
