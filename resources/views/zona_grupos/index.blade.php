...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            @if (Auth::check() && (Auth::user()->canCreate('estaciones.grupos') || Auth::user()->canCreate('usuarios.grupos')))
                <div class="mb-3">
                    <a href="{{ route('zonas.assign') }}" class="btn btn-primary">
        ...
        <div class="card-body border-top">
            <div class="d-flex justify-content-between align-items-center mb-3"> 
                <h6 class="font-weight-semibold mb-0">
                    <i class="icon-list mr-2"></i> Listado de Asignaciones de Zonas por Grupos
                </h6>
                        ...
                        <div class="grupo-item mb-3 p-3 border rounded shadow-sm" data-nivel="0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge badge-primary">
                                    <i class="icon-map5 mr-1"></i> {{ $asignacion->count() }} Zona(s) Asignada(s)
                                </span>
                            </div>
                                ...
                                <ul class="list-group">
                                    @foreach ($asignacion as $asig)
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <span>
                                                <i class="icon-map mr-2"></i> {{ $asig->zona_manejo->nombre }}
                                            </span>
                                            <form action="{{ route('zonas.remove') }}" method="POST" class="mb-0">
                                                @csrf
                                                ...
                                                <button type="submit" class="btn btn-sm btn-danger delete-button"
                                                    data-name="{{ $asig->zona_manejo->nombre }}">
