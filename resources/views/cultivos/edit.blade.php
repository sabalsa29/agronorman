                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <input type="text" name="nombre" value="{{ $cultivo->nombre }}" class="form-control"
                                        placeholder="Nombre">
                                </div>
                                <div class="col-4">
                                    <label class="col-form-label col-lg-12">Tipo de Cultivo / Variedad / Biotipo <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="descripcion" value="{{ $cultivo->descripcion }}"
                                        class="form-control" placeholder="Tipo de Cultivo / Variedad / Biotipo">
                                </div>
                                <div class="col-4">
                                    ...
                                    <select class="form-control" name="tipo_vida">
                                        ...
                                        <option value="1" {{ $cultivo->tipo_vida == 1 ? 'selected' : '' }}>Cíclica
                                        </option>
                                        <option value="2" {{ $cultivo->tipo_vida == 2 ? 'selected' : '' }}>Perene
                                        </option>
                                    </select>
                                </div>
                            </div>
                ...
                <fieldset class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label class="col-form-label col-lg-12">Temp. base <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="temp_base_calor" value="{{ $cultivo->temp_base_calor }}"
                                        class="form-control" placeholder="Temp. base">
                                </div>
                                <div class="col-6"></div>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-6">
                                    <label class="col-form-label col-lg-2">Imagen actual:</label>
                                    @if ($cultivo->imagen)
                                        <div><img src="{{ asset('storage/' . $cultivo->imagen) }}" alt="Imagen"
                                                style="max-width: 100px;"></div>
                                    @endif
                                    <label class="col-form-label col-lg-12 mt-2">Nueva imagen:</label>
                                    <input type="file" name="imagen" class="form-control-uniform" data-fouc>
                                </div>
                                <div class="col-lg-6">
                                    <label class="col-form-label col-lg-2">Icono actual:</label>
                                    @if ($cultivo->icono)
                                        <div><img src="{{ asset('storage/' . $cultivo->icono) }}" alt="Icono"
                                                style="max-width: 100px;"></div>
                                    @endif
                                    <label class="col-form-label col-lg-12 mt-2">Nuevo icono:</label>
