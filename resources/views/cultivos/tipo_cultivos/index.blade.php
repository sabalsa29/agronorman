...
@section('ruta_create', route('tipo_cultivos.create', $cultivo_id))
@section('styles')
    <!-- Theme JS files -->
                ...
                @forelse ($list as $row)
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="list-icons">
                                <a href="{{ route('tipo_cultivos.edit', ['id' => $cultivo_id, 'tipo_cultivo' => $row]) }}"
                                    class="list-icons-item text-primary-600"><i class="icon-pencil7"></i></a>
                                <form
                                    action="{{ route('tipo_cultivos.destroy', ['id' => $cultivo_id, 'tipo_cultivo' => $row]) }}"
                                ...
                                <a href="{{ route('parametros.index', ['id' => $cultivo_id, 'tipo_cultivo' => $row->id]) }}"
                                    class="list-icons-item text-primary-600">
                                    <button type="button" class="btn bg-green-800 btn-ladda btn-ladda-progress ml-3"
                                        data-style="slide-left">
                                        <span class="ladda-label">Parametros</span>
                                    </button>
                                </a>
                            </div>
                        </td>
