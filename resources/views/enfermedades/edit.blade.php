...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('enfermedades.update', $enfermedade) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <fieldset class="mb-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="nombre" value="{{ old('nombre', $enfermedade->nombre) }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <select name="status" class="form-control @error('status') is-invalid @enderror">
                                <option value="1" {{ old('status', $enfermedade->status) == 1 ? 'selected' : '' }}>
                                    Activo
                                </option>
                                <option value="0" {{ old('status', $enfermedade->status) == 0 ? 'selected' : '' }}>
                                    Inactivo
                                </option>
                            </select>
                            @error('status')
                ...
                <div class="text-right">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="icon-paperplane mr-2"></i>Actualizar Enfermedad
                    </button>
                </div>
            </form>
        </div>
