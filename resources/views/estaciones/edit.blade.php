...
@section('ruta', route('estaciones.create'))
@section('styles')
    <!-- Theme JS files -->
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('estaciones.update', $estacion) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <fieldset class="mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status">
                                            @foreach ($estatusOptions as $value => $label)
                                                <option value="{{ $value }}" @selected($estacion->status == $value)>
                                                    {{ $label }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="fabricante_id">
                                            @foreach ($fabricantes as $res)
                                                <option value="{{ $res->id }}" @selected($estacion->fabricante_id == $res->id)>
                                                    {{ $res->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="almacen_id">
                                            @foreach ($almacenes as $res)
                                                <option value="{{ $res->id }}" @selected($estacion->almacen_id == $res->id)>
                                                    {{ $res->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-6">
                                    <label class="col-form-label col-lg-12">Caracteristicas <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="caracteristicas" value="{{ $estacion->caracteristicas }}"
                                        class="form-control" placeholder="Caracteristicas">
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="uuid" value="{{ $estacion->uuid }}" class="form-control"
                                        placeholder="UUID">
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="tipo_estacion_id">
                                            @foreach ($tipos as $res)
                                                <option value="{{ $res->id }}" @selected($estacion->tipo_estacion_id == $res->id)>
                                                    {{ $res->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-6">
                            ...
                            <input type="text" name="celular" value="{{ $estacion->celular }}" class="form-control"
                                placeholder="Celular">
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control multiselect-select-all-filtering" name="variables_medicion_id[]"
                                    ...
                                    @foreach ($variables as $res)
                                        <option value="{{ $res->id }}" @selected(in_array($res->id, $estacion->variables->pluck('id')->toArray()))>
                                            {{ $res->nombre }}
                                        </option>
                                    @endforeach
                                </select>
