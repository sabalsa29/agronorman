...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('fabricantes.update', $fabricante) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <fieldset class="mb-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="nombre" value="{{ $fabricante->nombre }}" class="form-control">
                        </div>
                    </div>
                        ...
                        <div class="col-lg-10">
                            <div class="form-check form-check-inline form-check-switchery">
                                <label class="form-check-label">
                                    ...
                                    <input type="hidden" name="status" @checked($fabricante->status == 0) value="0">
                                    <!-- Enviará 1 si está activado -->
                                    <input type="checkbox" name="status" @checked($fabricante->status == 1) value="1"
